...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this record belongs to')),
                ('admission', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='billing', serialize=False, to='ipd.admission')),
                ('bill_number', models.CharField(help_text='Unique bill identifier (e.g., IPD-BILL/20231223/001)', max_length=50, unique=True)),
                ('bill_date', models.DateTimeField(auto_now_add=True)),
                ('total_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total bill amount', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ...
                ('balance_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Balance/due amount', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ...
                ('created_by_user_id', models.UUIDField(blank=True, db_index=True, help_text='User who created this bill', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='bed',
            field=models.ForeignKey(blank=True, help_text='Current bed assignment', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='admissions', to='ipd.bed'),
        ),
        migrations.CreateModel(
            name='BedTransfer',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('Bed', 'Bed Charges'), ('Pharmacy', 'Pharmacy'), ('Lab', 'Laboratory'), ('Radiology', 'Radiology'), ('Consultation', 'Consultation'), ('Procedure', 'Procedure'), ('Surgery', 'Surgery'), ('Other', 'Other')], default='Other', help_text='Source/category of the charge', max_length=20)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('billing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='ipd.ipdbilling')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='ipdbilling',
            index=models.Index(fields=['tenant_id', 'status'], name='ipd_billing_tenant__9258c8_idx'),
        ),
        migrations.AddIndex(
            model_name='ipdbilling',
        ...
        migrations.AddIndex(
            model_name='ipdbilling',
            index=models.Index(fields=['status'], name='ipd_bill_status_idx'),
        ),
        migrations.AddIndex(
            model_name='bedtransfer',
            index=models.Index(fields=['tenant_id'], name='ipd_bed_tra_tenant__5574a0_idx'),
        ),
        migrations.AddIndex(
            model_name='bedtransfer',
            index=models.Index(fields=['admission', '-transfer_date'], name='ipd_bed_tra_admissi_514928_idx'),
        ),
        migrations.AddIndex(
            model_name='bedtransfer',
            index=models.Index(fields=['transfer_date'], name='ipd_bed_tra_transfe_3c90ef_idx'),
        ),
        migrations.AddIndex(
            model_name='bed',
        ...
        migrations.AddIndex(
            model_name='ipdbillitem',
            index=models.Index(fields=['billing', 'source'], name='ipd_bill_it_billing_8ca953_idx'),
        ),
    ]
