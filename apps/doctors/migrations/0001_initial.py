    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this specialty belongs to')),
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['tenant_id'], name='specialties_tenant__fe120d_idx'), models.Index(fields=['name'], name='specialties_name_ea5b66_idx'), models.Index(fields=['code'], name='specialties_code_dec0e7_idx'), models.Index(fields=['is_active'], name='specialties_is_acti_0369e1_idx'), models.Index(fields=['tenant_id', 'is_active'], name='specialties_tenant__f2fea0_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this doctor belongs to')),
                ('user_id', models.UUIDField(db_index=True, help_text='SuperAdmin User ID (required for doctors)', unique=True)),
                ('first_name', models.CharField(blank=True, help_text="Doctor's first name (cached from SuperAdmin or manually entered)", max_length=100, null=True)),
                ('last_name', models.CharField(blank=True, help_text="Doctor's last name (cached from SuperAdmin or manually entered)", max_length=100, null=True)),
                ('medical_license_number', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('consultation_fee', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Consultation fee in INR', max_digits=10, null=True)),
                ('follow_up_fee', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Follow-up consultation fee in INR', max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this availability belongs to')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant_id'], name='doctor_avai_tenant__ce77ff_idx'), models.Index(fields=['doctor', 'day_of_week'], name='doctor_avai_doctor__b54d61_idx'), models.Index(fields=['is_available'], name='doctor_avai_is_avai_577882_idx'), models.Index(fields=['tenant_id', 'doctor'], name='doctor_avai_tenant__7bbfea_idx')],
                'unique_together': {('doctor', 'day_of_week', 'start_time')},
            },
        ),
        migrations.AddIndex(
            model_name='doctorprofile',
            index=models.Index(fields=['tenant_id'], name='doctor_prof_tenant__e98041_idx'),
        ),
        migrations.AddIndex(
            model_name='doctorprofile',
            index=models.Index(fields=['user_id'], name='doctor_prof_user_id_5db1fe_idx'),
        ),
        migrations.AddIndex(
            model_name='doctorprofile',
        ...
        migrations.AddIndex(
            model_name='doctorprofile',
            index=models.Index(fields=['tenant_id', 'status'], name='doctor_prof_tenant__e0bcf0_idx'),
        ),
