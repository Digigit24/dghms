    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='procedure_bills', to='opd.visit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant_id'], name='procedure_b_tenant__8fd652_idx'), models.Index(fields=['tenant_id', 'procedure_bill'], name='procedure_b_tenant__10db36_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['tenant_id'], name='procedure_p_tenant__e51d66_idx'), models.Index(fields=['tenant_id', 'is_active'], name='procedure_p_tenant__549ea1_idx'), models.Index(fields=['code'], name='proc_package_code_idx'), models.Index(fields=['is_active'], name='proc_package_active_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='visit',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['tenant_id'], name='procedure_b_tenant__3f074f_idx'),
        ),
        migrations.AddIndex(
            model_name='procedurebill',
            index=models.Index(fields=['tenant_id', 'bill_date'], name='procedure_b_tenant__f66c41_idx'),
        ),
        migrations.AddIndex(
            model_name='procedurebill',
            index=models.Index(fields=['tenant_id', 'payment_status'], name='procedure_b_tenant__4b9d4f_idx'),
        ),
        migrations.AddIndex(
            model_name='procedurebill',
