...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='visit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template_responses', to='opd.visit'),
        ),
        migrations.CreateModel(
            name='ClinicalNote',
            fields=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['tenant_id'], name='procedure_b_tenant__8fd652_idx'),
        ),
        migrations.AddIndex(
            model_name='procedurebillitem',
            index=models.Index(fields=['tenant_id', 'procedure_bill'], name='procedure_b_tenant__10db36_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='clinicalnotetemplateresponse',
            index=models.Index(fields=['visit'], name='clinical_no_visit_i_2e1f64_idx'),
        ),
        migrations.AddIndex(
            model_name='clinicalnotetemplateresponse',
