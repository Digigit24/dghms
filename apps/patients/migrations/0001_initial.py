    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this patient belongs to')),
                ('user_id', models.UUIDField(blank=True, db_index=True, help_text='SuperAdmin User ID (null for walk-in patients)', null=True)),
                ...
                ('created_by_user_id', models.UUIDField(blank=True, db_index=True, help_text='SuperAdmin User ID who created this patient', null=True)),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['tenant_id'], name='patient_pro_tenant__b5ae65_idx'), models.Index(fields=['user_id'], name='patient_pro_user_id_27548b_idx'), models.Index(fields=['patient_id'], name='patient_pro_patient_ab14ea_idx'), models.Index(fields=['mobile_primary'], name='patient_pro_mobile__13fd15_idx'), models.Index(fields=['last_name', 'first_name'], name='patient_pro_last_na_653e81_idx'), models.Index(fields=['status'], name='patient_pro_status_79548d_idx'), models.Index(fields=['tenant_id', 'status'], name='patient_pro_tenant__6debd2_idx')],
            },
        ),
        migrations.CreateModel(
            name='PatientAllergy',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('recorded_by_user_id', models.UUIDField(blank=True, db_index=True, help_text='SuperAdmin User ID who recorded this allergy', null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant_id'], name='patient_all_tenant__530f03_idx'), models.Index(fields=['patient', 'is_active'], name='patient_all_patient_8c3cd4_idx'), models.Index(fields=['tenant_id', 'patient'], name='patient_all_tenant__cb68a1_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant this record belongs to')),
                ('recorded_by_user_id', models.UUIDField(blank=True, db_index=True, help_text='SuperAdmin User ID who recorded these vitals', null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant_id'], name='patient_vit_tenant__5c6279_idx'), models.Index(fields=['patient', '-recorded_at'], name='patient_vit_patient_cc161e_idx'), models.Index(fields=['tenant_id', 'patient'], name='patient_vit_tenant__52b64b_idx')],
            },
        ),
    ]
