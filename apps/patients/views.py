...
class PatientProfileViewSet(TenantViewSetMixin, viewsets.ModelViewSet):
    ...
    def statistics(self, request):
        ...
        # see apps/patients/services/stats.py (tenant-scoped in the service,
        # serialized through PatientStatisticsSerializer).
        from .services.stats import compute_patient_statistics

        data = compute_patient_statistics(request.tenant_id, group_by_day=group_by_day)
